...
//     let metadata = self.segment_metadata_cache.get(&segment_key).await;
//
...
//   }
//
//   fn plan_compaction(&self, schema: &Schema, metadata: &SegmentMetadata) -> Compaction {
...
//
//     Compaction {
//       compacted_n: metadata.flushed_n,
//       col_codecs,
//     }
//   }
//
...
//     self.segment_metadata_cache.add_write_version(&segment_key, new_version).await?;
//
...
//     ).await?;
//
//     self.segment_metadata_cache.update_read_version(&segment_key, new_version).await?;
//     Ok(())
//   }
// }
